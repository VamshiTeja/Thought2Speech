#!/usr/bin/python
# -*- coding:utf-8 -*-
''' DeepSpeech2 model implemented in Tensorflow
...
class DeepSpeech2_orig(object):
    ...
    def build_graph(self, args, maxTimeSteps):
        ...
        with self.graph.as_default():
            ...
            inputXrs = tf.reshape(self.inputX, [args.batch_size, args.num_feature, maxTimeSteps, 62])
            ...
            self.targetVals = tf.placeholder(tf.int6432)
