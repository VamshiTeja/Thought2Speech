...
flags.DEFINE_string('datadir', '/home/vamshi/Projects/Thought2Speech/T2S/data/', 'set the data root directory')
flags.DEFINE_string('logdir', '/home/vamshi/Projects/Thought2Speech/T2S/logdi', 'set the log directory')
